...
import etv from "../assets/images/partners/Etv.png";
import molad from "../assets/images/partners/image.png";

export const PARTNERS = [{ name: "Ethiopian Airlines", image: molad }];

export const CLIENTS_HERO = {
  eyebrow: "Clients & Partners",
  title: "Trusted by employers across the Gulf and the world.",
  description:
    "We work alongside leading companies, governments and international organizations to connect people to opportunities — safely and efficiently.",
};
...
export const CLIENTS_HEADER = {
  ...
  description:
    "Collaborating with authorized labor ministries and leading employers in the Middle East.",
};
