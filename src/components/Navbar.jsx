          ...
          <nav className="hidden items-center lg:flex lg:gap-8">
            {navItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    "text-[15px] font-semibold text-primary transition-colors hover:text-accent",
            ...
            <nav className="flex flex-col gap-1">
              {navItems.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    cn(
                      "rounded-lg px-4 py-3 text-base font-semibold transition-colors hover:bg-secondary hover:text-accent",
              ...
              <div className="mt-6 pt-6 border-t border-border/10 text-sm">
                <div className="flex flex-col gap-3 font-medium text-primary/70 mb-6">
                  <p>
                    <span className="text-primary/40">location:</span>{" "}
                    {FOOTER_CONTENT.address?.join(", ")}
                  </p>
                  <a href={`mailto:${FOOTER_CONTENT.email}`} className="text-accent font-semibold">
                    {FOOTER_CONTENT.email}
                  </a>
                  {FOOTER_CONTENT.phone?.map((num) => (
